...
module LNX11
  ...
  # アクターエリア背景の高さ
  ACTOR_BACKGROUND_HEIGHT = 120 # 規定値:112
  ...
  # 行動の表示始めの追加ウェイト
  HELPDISPLAT_WAIT        = 10    # 規定値:20

  # 行動の表示終了までの追加ウェイト
  HELPDISPLAT_END_WAIT    = 12    # 規定値:24
  ...
  ACTOR_OFFSET  = {:x => 0, :y => 0}       # 規定値:{:x => -16, :y => 0}

  # アクターエリアと画面端との余白 :side = 左右の余白 / :bottom = 下の余白
  ACTOR_PADDING = {:side => 4, :bottom => 0} # 規定値:{:side => 4, :bottom => 8}
  ...
  ACTOR_COMMAND_HORIZON    = true # 規定値:false

  # 文字揃え 0 = 左揃え / 1 = 中央揃え / 2 = 右揃え
  ACTOR_COMMAND_ALIGNMENT  = 1     # 規定値:0

  # ウィンドウの横幅
  # 　コマンドを横並びにする場合、大きめの値を設定してください。
  ACTOR_COMMAND_WIDTH      = 320   # 規定値:128
  ...
  CURSOR_NAME       = "Lnx11_cursor_black.png"    # 規定値:""
  ...
  # 数字
  LARGE_NUMBER_NAME = "popup_number01_large.png"       # 規定値:""
  SMALL_NUMBER_NAME = "popup_number01_small.png"       # 規定値:""
  # 能力強化/弱体
  LARGE_BUFFS_NAME  = "popup_buffs_large"       # 規定値:""
  SMALL_BUFFS_NAME  = "popup_buffs_small"       # 規定値:""
  ...
  POPUP_COLOR = {
    ...
    # TP 増減
    :tp_damage     => [Color.new(248, 255, 104), Color.new(  0,  80,  40)],
    # 有利なステートの付加
  ...
  GUARD_TARGET_CHECKE   = false   # 規定値:true
